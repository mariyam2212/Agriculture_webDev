        ...
        <div id="main" >
            ...
            <div id="right">
                ...
                <div id="registration">
                    ...
                    <B>
                        <form action="SaveHarvestForm.jsp" method="Post">
                        <center><font color="green"><h2>Harvest Form</h2></font></center>
                        &nbsp;&nbsp;&nbsp;  Harvest Code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text"  placeholder="Harvest Code"name="code" size="20px" value="<%out.println(new Random().nextInt(100000));%>"/><br/><br/>
                  &nbsp;&nbsp;&nbsp;    Harvest Date:&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="date" placeholder="Harvest Date" name="date" size="20px"/><br/><br/>
