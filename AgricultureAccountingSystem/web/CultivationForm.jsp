        ...
        <div id="main" >
            ...
            <div id="right">
                ...
                <div id="registration">
                    ...
                    <B>
                        <form action="SaveCultivationForm.jsp" method="Post">
                        <center><font color="green"><h2>Cultivation Form</h2></font></center>
                        &nbsp;&nbsp;&nbsp;  Cultivation Code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text"  placeholder="Cultivation Code" name="cultiCode" size="20px" value="<%out.println(new Random().nextInt(10000));%>" /><br/><br/>
                  &nbsp;&nbsp;&nbsp;    Operation:&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" placeholder="Operation" name="operation" size="20px"/><br/><br/>
                  &nbsp;  &nbsp;  Cost: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="text" name="cost" size="20px" placeholder="Cost"/><br/><br/>
                 
                  &nbsp;&nbsp;&nbsp;&nbsp;Labor Cost : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="laborcost" size="20px" placeholder="Labor Cost"/><br/><br/>
               &nbsp;&nbsp;&nbsp;  Select Land: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
