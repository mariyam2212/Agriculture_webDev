        ...
        <div id="main" >
            ...
            <div id="right">
                ...
                <div id="registration">
                    ...
                    <B>
                        <form action="SaveFertilizerForm.jsp" method="Post">
                        <center><font color="green"><h2>Fertilizer Form</h2></font></center>
                        &nbsp;&nbsp;&nbsp; Fertilizer Code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text"  placeholder="Fertilizer code"name="ferticode" size="20px" value="<%out.println(new Random().nextInt(100000));%>"/><br/><br/>
