        ...
        <div id="main" >
            ...
            <div id="right">
                ...
                <div id="registration">
                    ...
                    <B>
                        <form action="SaveSowingForm.jsp" method="Post">
                        <center><font color="green"><h2>Sowing Form</h2></font></center>
                        &nbsp;&nbsp;&nbsp;  Sowing Code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text"  placeholder="Sowing Code" name="sowcode" size="20px" value="<%out.println(new Random().nextInt(100000));%>"/><br/><br/>
                  &nbsp;&nbsp;&nbsp;    Labor Cost:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" placeholder="Labor Cost" name="labcost" size="20px"/><br/><br/>
                  &nbsp;  &nbsp;  Seed Cost: &nbsp;&nbsp;&nbsp; &nbsp;  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="text" name="seedcost" size="20px" placeholder="Seed Cost"/><br/><br/>
                  &nbsp;&nbsp;&nbsp;  Select Land: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
