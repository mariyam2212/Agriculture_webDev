        ...
        <div id="main" >
            ...
            <div id="right">
                ...
                <div id="registration">
                    ...
                    <B>
                        <form action="SaveLabourForm.jsp" method="Post">
                        <center><font color="green"><h2>Labor Form</h2></font></center>
                        &nbsp;&nbsp;&nbsp;  Labor Code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text"  placeholder="Labor Code"name="labcode" size="20px" value="<%out.println(new Random().nextInt(100000));%>"/><br/><br/>
                  &nbsp;&nbsp;&nbsp;    Name:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" placeholder="Name" name="name" size="20px"/><br/><br/>
                  &nbsp;  &nbsp;  Wage: &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="text" name="wage" size="20px" placeholder="Wage"/><br/><br/>
                 
                  &nbsp;&nbsp;&nbsp;&nbsp;Working Days: 
                  &nbsp;&nbsp;&nbsp;<input type="text" name="wday" size="20px" placeholder="Working Days"/><br/><br/>
               &nbsp;&nbsp;&nbsp;  Select Land: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
