        ...
        <div id="main" >
            ...
            <div id="right">
                ...
                <div id="registration">
                    ...
                    <B> 
                        <form action="SaveDayBookPage.jsp" method="Post">
                            <table>
                                <tr>
                                    <td>S.No</td>
                                    <td>Particular</td>
                                ...
                                <tr>
                                    <td><input type="text" name="serialNumber" size="3"></td>
                                    <td><input type="text" name="particular" size="15"></td>
                                    <td><input type="text" name="DR" size="3"></td>
                                    <td><input type="text" name="CR" size="3"></td>
                                ...
                                try
                                {
                                    ...
                                    PreparedStatement ps=connection.prepareStatement("select SERIALNUMBER,PARTICULAR,DEBITAMOUNT,CREDITAMOUNT,DATE FROM daybook where FARMERCODE=?");
                                    ...
                                    while(rs.next())
                                    {
                                        %>
                                        <tr>
                                            <td align="Center"><font size="2" color="Green"><%=(i++)%></font></td>
                                            <td><font size="2" color="Green"><%=rs.getString(2).toUpperCase()%></font></td>
                                            <td align="center"><font size="2" color="Green"><%=rs.getString(3)%></font></td>
                                            <td align="center"><font size="2" color="Green"><%=rs.getString(4)%></font></td>
                                            <td align="center"><font size="2" color="Green"><%=rs.getString(5)%></font></td>
                                        </tr>
                                        <%
                                    }                                    
                                }
