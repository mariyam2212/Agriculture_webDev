        ...
        <div id="main" >
            ...
            <div id="right">
                ...
                <div id="login">
                    ...
                    <center><font color="green"><h2>LogIn page</h2></font></center><br/><br/>
                    Farmer Code: <input type="text" placeholder="Farmer Code" name="code" size="20px"/><br/><br/>
                    Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" placeholder="Password" name="password" size="20px"/><br/><br/>
                    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    <a href="NewFarmer.jsp"><input type="button" value="New Farmer"> </a> &nbsp; &nbsp; &nbsp; &nbsp;
